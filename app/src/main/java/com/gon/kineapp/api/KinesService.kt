...
object KinesService {
    ...
    fun getPublicVideos(): Observable<PublicVideosListResponse> {
        ...
        val videos = listOf(
            Video("8722", "Ejercicio de mano rápida", "https://resizer.iprofesional.com/unsafe/640x/https://assets.iprofesional.com/assets/jpg/2019/07/481410_landscape.jpg?3.5.0", "http://clips.vorwaerts-gmbh.de/VfE_html5.mp4", true),
