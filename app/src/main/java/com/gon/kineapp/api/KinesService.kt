...
object KinesService {
    ...
    fun getPublicVideos(): Observable<PublicVideosListResponse> {
        ...
        val videos = listOf(
            Video("8722", "Ejercicio de cuello", "https://resizer.iprofesional.com/unsafe/640x/https://assets.iprofesional.com/assets/jpg/2019/07/481410_landscape.jpg?3.5.0", "http://198.199.121.38/media/VID_20190928_192304.mp4"),
            ...
            Video("8782", "Otro ejercicio para la rodilla", "https://www.pointloma.edu/sites/default/files/styles/16_9_1200w/public/images/ATC.jpg?itok=pII3XLSJ", "http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4"),
